...
## Preámbulo
Librería que permite leer y analizar archivos [Markdown](https://es.wikipedia.org/wiki/Markdown), verificando los links que contienen y reporta algunas estadísticas.
