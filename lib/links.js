...
const getLinks2 = (routeFile, content) => {
  let contentFile = content;
  const arr = [];
  for (let i = 0; i < contentFile.length; i + 1) {
    const aux = contentFile.indexOf('[');
...
console.log(getLinks2('C:\\Users\\User\\Desktop\\LIM010-fe-md-links\\test\\folder\\ALGO.md', getContent('C:\\Users\\User\\Desktop\\LIM010-fe-md-links\\test\\folder\\ALGO.md')));
